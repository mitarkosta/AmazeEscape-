...
function spinGame() {
    ...
    /*
     * Important:
     * This click is a real user gesture.
     * AudioContext is therefore safe to resume here.
     */
...
function stopReels() {
     ...
     *
     * Before reel 3 stops:
     * check whether reel 1 and reel 2
...
function startAnticipation(
    ...
    /*
     * Give the anticipation scene
     * a short dramatic moment.
     */
...
function collectPersistentReward() {
    ...
    /*
     * Every 3 identical fruits:
     * add one unit to persistent meter.
     */
     ...
     * reset the meter and give a stronger reward.
     */
