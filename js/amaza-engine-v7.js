...
function buildReelStrip(
    ...
    /*
     * We use two identical sequences.
     *
     * This allows the reel to travel
     * through a complete symbol sequence
     * without revealing the final symbol.
     */
...
/* ==========================================================
   START REAL REEL SPIN
========================================================== */

function startRealReelSpin(
    slot,
    reelIndex
) {
...
function setReelFinalSymbol(
    ...
    /*
     * We add two extra symbols above
     * and two below.
     *
     * This gives the visible reel
     * a real three-symbol window.
     */
        ...
        () => {
            ...
            requestAnimationFrame(
                () => {
                    ...
                    strip.style.transition =
                        "transform .38s cubic-bezier(.16,.85,.25,1)";
...
function startReels() {
    ...
    /*
     * After 1.7 sec we start
     * the staggered stopping.
     */
...
function stopReels() {
     ...
     * IMPORTANT:
     *
     * It is NOT stopped here when
     * the first two symbols match.
     *
     * It continues spinning through
     * the complete 2.5 second
     * anticipation.
     */
...
function stopSingleReel(
    ...
    /*
     * Pick final symbol only now.
     *
     * This is important for the final reel:
     * it does NOT know its result during
     * anticipation.
     */
    ...
    /*
     * Small vibration on each reel stop.
     */
...
function startAnticipation(
    ...
    /*
     * REAL FINAL REEL CONTINUES SPINNING.
     *
     * We explicitly restart it here
     * so the reel is physically moving
